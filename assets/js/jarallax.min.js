...
! function(e) { "use strict";
    ...
    t(); var g = [],
        f = function() {
            function e(e, n) { var o, i = this;
                i.$item = e, i.defaults = { type: "scroll", speed: .5, imgSrc: null, imgWidth: null, imgHeight: null, enableTransform: !0, zIndex: -100, noAdnroid: !1, noIos: !0, onScroll: null, onInit: null, onDestroy: null, onCoverImage: null }, o = JSON.parse(i.$item.getAttribute("data-jarallax") || "{}"), i.options = i.extend({}, i.defaults, o, n), s && i.options.noAdnroid || l && i.options.noIos || (i.options.speed = Math.min(2, Math.max(-1, parseFloat(i.options.speed))), i.instanceID = t++, i.image = { src: i.options.imgSrc || null, $container: null, $item: null, width: i.options.imgWidth || null, height: i.options.imgHeight || null, useImgTag: l || s || c || p || u || m }, i.initImg() && i.init()) } var t = 0; return e }();
    f.prototype.css = function(e, t) { if ("string" == typeof t) return e.style[t];
        t.transform && (t.WebkitTransform = t.MozTransform = t.transform); for (var n in t) e.style[n] = t[n]; return e }, f.prototype.extend = function(e) { e = e || {}; for (var t = 1; t < arguments.length; t++)
            if (arguments[t])
                for (var n in arguments[t]) arguments[t].hasOwnProperty(n) && (e[n] = arguments[t][n]);
        return e }, f.prototype.initImg = function() { var e = this; return null === e.image.src && (e.image.src = e.css(e.$item, "background-image").replace(/^url\(['"]?/g, "").replace(/['"]?\)$/g, "")), e.image.src && "none" !== e.image.src ? !0 : !1 }, f.prototype.init = function() {
        ...
        e.$item.setAttribute("style", e.$item.getAttribute("data-jarallax-original-styles")), e.$item.removeAttribute("data-jarallax-original-styles"), e.$clipStyles && e.$clipStyles.parentNode.removeChild(e.$clipStyles), e.image.$container.parentNode.removeChild(e.image.$container), e.options.onDestroy && e.options.onDestroy.call(e), delete e.$item.jarallax; for (var o in e) delete e[o] }, f.prototype.getImageSize = function(e, t) { if (e && t) { var n = new Image;
            ...
            t.isElementInViewport = n.bottom >= 0 && n.right >= 0 && a >= o && n.left <= i; var c = e ? !1 : !t.isElementInViewport; if (!c) { var m = Math.max(0, o),
                    ...
                    r && t.options.enableTransform ? (t.parentWithTransform && (b -= o), l.transform = "translate3d(0, " + b + "px, 0)") : (t.bgPosVerticalCenter && (b += t.bgPosVerticalCenter), l.backgroundPosition = "50% " + b + "px"), l.position = d ? "absolute" : "fixed" }
                t.css(t.image.$item, l), t.options.onScroll && t.options.onScroll.call(t, { section: n, beforeTop: m, beforeTopEnd: p, afterTop: u, beforeBottom: g, beforeBottomEnd: f, afterBottom: h, visiblePercent: v, fromViewportCenter: y }) } } }, n(e, "scroll", o), n(e, "resize", o), n(e, "orientationchange", o), n(e, "load", o); var h = function(e) {
    ...
    n(e, "DOMContentLoaded", function() { h(document.querySelectorAll("[data-jarallax]")) }) }(window);